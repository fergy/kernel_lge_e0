...
#define ACCEL_I2C_ADDRESS		0x10 /* slave address 7bit - L4II_CDMA BMA250 accelerometer sensor */
#else
#define ACCEL_I2C_ADDRESS		0x18 /* slave address 7bit - L4II_CDMA BMA250 accelerometer sensor */
#endif
...
#else
#define ECOM_I2C_ADDRESS		0x10 /* slave address 7bit - L4II_CDMA bmm050 bosch compass sensor */
#endif
/*                                                                */
...
#define SENSOR_GPIO_I2C_SCL		85
#define SENSOR_GPIO_I2C_SDA		84
...
#endif	// end of CONFIG_MACH_MSM7X27A_L4II_CDMA 
/*                                         */
...
#define GPIO_BUTTON_DETECT 		28	 // biglake change gpio no
...
#define TS_GPIO_I2C_SCL			9
#define TS_GPIO_IRQ			39
#define TS_I2C_SLAVE_ADDR               0xA0>>1
//#define TS_TOUCH_LDO_EN			14
#define TS_TOUCH_ID				121
...
/*                                         */
#if !defined(CONFIG_LGE_TOUCHSCREEN_SYNAPTICS_I2C_RMI4) && defined(CONFIG_TOUCHSCREEN_MELFAS_MMS136) /*L4II_CDMA Rev.b melfas touch*/
#define MELFAS_TS_NAME "melfas-ts"
...
#endif /*L4II_CDMA Rev.b melfas touch*/
/*                                         */
