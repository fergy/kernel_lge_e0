...
void __init msm7x27a_l4ii_cdma_init_i2c_backlight(int bus_num)
{
...
#if defined (CONFIG_FB_MSM_MIPI_DSI_ILI9488)
static struct platform_device mipi_dsi_ili9488_panel_device = {
	.name = "mipi_ili9488",
	.id = 0,
};

/* input platform device */
static struct platform_device *l4ii_cdma_panel_devices[] __initdata = {
	&mipi_dsi_ili9488_panel_device,
};
#endif
void __init msm_msm7627a_allocate_memory_regions(void)
{
	...
	else if (machine_is_msm7x27a_l4ii_cdma()) 
...
void __init msm_fb_add_devices(void)
{
	...
	platform_add_devices(l4ii_cdma_panel_devices, ARRAY_SIZE(l4ii_cdma_panel_devices));
	...
	lge_add_gpio_i2c_device(msm7x27a_l4ii_cdma_init_i2c_backlight);
