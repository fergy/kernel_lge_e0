...
static struct gpio t8ev4_cam_req_gpio[] = {
...
static struct msm_gpio_set_tbl t8ev4_cam_gpio_set_tbl[] = {
...
static struct msm_camera_gpio_conf gpio_conf_t8ev4 = {
	.camera_off_table = t8ev4_cam_off_gpio_table,
	.camera_off_table_size = ARRAY_SIZE(t8ev4_cam_off_gpio_table),
	.camera_on_table = t8ev4_cam_on_gpio_table,
	.camera_on_table_size = ARRAY_SIZE(t8ev4_cam_on_gpio_table),
	.cam_gpio_req_tbl = t8ev4_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(t8ev4_cam_req_gpio),
	.cam_gpio_set_tbl = t8ev4_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(t8ev4_cam_gpio_set_tbl),
	.gpio_no_mux = 1,
};
#endif
...
static uint32_t imx111_cam_on_gpio_table[] = {
	GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), // mclk
};

static struct gpio imx111_cam_req_gpio[] = {
	{49, GPIOF_DIR_OUT, "CAM_DVDD"},
	{48, GPIOF_DIR_OUT, "CAM_AVDD"},
	{128, GPIOF_DIR_OUT, "CAM_IOVDD"},
	{23, GPIOF_DIR_OUT, "CAM_VCM"},
...
static struct msm_camera_gpio_conf gpio_conf_t8ev4 = {
	...
	.camera_on_table_size = ARRAY_SIZE(imx111_cam_on_gpio_table),
	.cam_gpio_req_tbl = imx111_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(imx111_cam_req_gpio),
	.cam_gpio_set_tbl = imx111_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(imx111_cam_gpio_set_tbl),
	.gpio_no_mux = 1,
};
#endif
/*                                                               */
...
static uint32_t hi707_cam_on_gpio_table[] = {
	GPIO_CFG(15, 1, GPIO_CFG_OUTPUT, GPIO_CFG_PULL_DOWN, GPIO_CFG_2MA), // mclk
};

#ifdef CONFIG_HI707_PWR_SEPARATE // EVB, Rev A
static struct gpio hi707_cam_req_gpio[] = {
	{128, GPIOF_DIR_OUT, "CAM_IOVDD"},
	{48, GPIOF_DIR_OUT, "CAM_AVDD"},
	{49, GPIOF_DIR_OUT, "CAM_DVDD"},
};

static struct msm_gpio_set_tbl hi707_cam_gpio_set_tbl[] = {
...
#else // After Rev B
static struct gpio hi707_cam_req_gpio[] = {
	{128, GPIOF_DIR_OUT, "CAM_IO_DVDD"}, // iovdd18, dvdd18
	{48, GPIOF_DIR_OUT, "CAM_AVDD"},
	//{49, GPIOF_DIR_OUT, "CAM_DVDD"},
};

static struct msm_gpio_set_tbl hi707_cam_gpio_set_tbl[] = {
	{128, GPIOF_OUT_INIT_HIGH, 0}, // iovdd18, dvdd18
	{48, GPIOF_OUT_INIT_HIGH, 0}, // avdd28
	//{49, GPIOF_OUT_INIT_HIGH, 1000}, // dvdd18
};
#endif

static struct msm_camera_gpio_conf gpio_conf_hi707 = {
	.camera_off_table = hi707_cam_off_gpio_table,
	.camera_off_table_size = ARRAY_SIZE(hi707_cam_off_gpio_table),
	.camera_on_table = hi707_cam_on_gpio_table,
	.camera_on_table_size = ARRAY_SIZE(hi707_cam_on_gpio_table),
	.cam_gpio_req_tbl = hi707_cam_req_gpio,
	.cam_gpio_req_tbl_size = ARRAY_SIZE(hi707_cam_req_gpio),
	.cam_gpio_set_tbl = hi707_cam_gpio_set_tbl,
	.cam_gpio_set_tbl_size = ARRAY_SIZE(hi707_cam_gpio_set_tbl),
	.gpio_no_mux = 1,
};
#endif
/*                                                               */
...
static struct msm_camera_sensor_platform_info sensor_board_info_t8ev4 = {
	.mount_angle	= 90,
	//.cam_vreg = msm_cam_vreg,
	//.num_vreg = ARRAY_SIZE(msm_cam_vreg),
...
static struct msm_camera_sensor_info msm_camera_sensor_t8ev4_data = {
	...
	.sensor_platform_info   = &sensor_board_info_t8ev4,
	.csi_if                 = 1,
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
#ifdef CONFIG_T8EV4_ACT
...
/*                                                               */
		...
		sensor_board_info_t8ev4.num_vreg = 0;
#endif
#ifdef CONFIG_IMX111
