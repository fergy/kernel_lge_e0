...
int android_log_dumper_enable(void)
{
	return uart_console_mode;
}
EXPORT_SYMBOL(android_log_dumper_enable);
#endif
/*                                             */
...
//                                                       
#if defined(CONFIG_MACH_MSM7X27A_U0) || defined(CONFIG_MACH_MSM7X25A_V1) || defined(CONFIG_MACH_MSM7X27A_L4II_CDMA)
