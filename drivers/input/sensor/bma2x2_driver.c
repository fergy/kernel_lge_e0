...
#define BMA2X2_SHAKING_DETECT_THRESHOLD	(300)	 //clubsh cal2 50 -> 200 
#endif
...
#else
static DEVICE_ATTR(x, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_x_show, NULL);
static DEVICE_ATTR(y, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_y_show, NULL);
static DEVICE_ATTR(z, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_z_show, NULL);
static DEVICE_ATTR(cal_result,S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_cal_result_show, NULL);
static DEVICE_ATTR(cnt, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_diag_cnt_show, NULL);
static DEVICE_ATTR(diag, S_IRUGO|S_IWUSR|S_IWGRP|S_IWOTH,
		bma2x2_diag_show, bma2x2_diag_store);
#endif
#endif
