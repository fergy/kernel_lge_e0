...
#define lgit_fw_ver 13
#define	suntel_fw_ver 13
 ...
 // INT8 dl_enable_bit = 0x00;
  ...
  INT8 version_info = 0;
	...
	//------------------------
	              	...
	              	if( country==2 ) //Eu SUNTEL
	              	{
	              		printk("<MELFAS> mms100_ISC_download : Suntel Panel \n");
	              		nRet = mms100_ISC_download( (const UINT8*) MELFAS_binary2, (const UINT16)MELFAS_binary_nLength2, 0);
	              	}
	              	else if(country==3)//EU INotek
	              	{
	              		printk("<MELFAS> mms100_ISC_download : Inotek Panel \n");
	              		nRet = mms100_ISC_download( (const UINT8*) MELFAS_binary3, (const UINT16)MELFAS_binary_nLength3, 0);
	              	}
	              	else if(country==4) //BR NEW
	              	{
	              		printk("<MELFAS> mms100_ISC_download : Suntel Panel \n");
	              		nRet = mms100_ISC_download( (const UINT8*) MELFAS_binary4, (const UINT16)MELFAS_binary_nLength4, 0);
	              	}
					else if(country==5) //e617
	              	{
	              		printk("<MELFAS> mms100_ISC_download : Suntel Panel \n");
	              		nRet = mms100_ISC_download( (const UINT8*) MELFAS_binary5, (const UINT16)MELFAS_binary_nLength5, 0);
	              	}
					else
	              	{
	              		printk("<MELFAS> mms100_ISC_download : Suntel Panel \n");
	              		nRet = mms100_ISC_download( (const UINT8*) MELFAS_binary6, (const UINT16)MELFAS_binary_nLength6, 0);
	              	}
