...
static struct msm_camera_i2c_reg_conf hi351_prev_settings[] = {
	...
	{0x3A, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x3B, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x3C, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x3D, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x3E, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x3F, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x40, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x41, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x42, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x43, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x44, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x45, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x46, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x47, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x48, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x49, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4A, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4B, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4C, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4D, 0x21, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4E, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x4F, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x50, 0x12, MSM_CAMERA_I2C_BYTE_DATA},
	{0x51, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x52, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x53, 0x22, MSM_CAMERA_I2C_BYTE_DATA},
	{0x54, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x55, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x56, 0x22, MSM_CAMERA_I2C_BYTE_DATA},
	{0x57, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x58, 0x21, MSM_CAMERA_I2C_BYTE_DATA},
	{0x59, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5A, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5B, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5C, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5D, 0x12, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5E, 0x21, MSM_CAMERA_I2C_BYTE_DATA},
	{0x5F, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x60, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x61, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x62, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x63, 0x12, MSM_CAMERA_I2C_BYTE_DATA},
	{0x64, 0x21, MSM_CAMERA_I2C_BYTE_DATA},
	{0x65, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x66, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x67, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x68, 0x44, MSM_CAMERA_I2C_BYTE_DATA},
	{0x69, 0x12, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6A, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6B, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6C, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6D, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6E, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	{0x6F, 0x11, MSM_CAMERA_I2C_BYTE_DATA},
	...
	// need to check
		{
			...
			//AWB target RG angle
			{0xaa, 0x32},//aInRgTgtOfs_a00_n00
			{0xab, 0x28},//aInRgTgtOfs_a01_n00
			...
			//AWB target BG angle
			{0xb2, 0xb2},//aInBgTgtOfs_a00_n00
			{0xb3, 0xa8},//aInBgTgtOfs_a01_n00
			...
			{0xb9, 0x64},//bOutRgainMin_a00_n00
			{0xba, 0xf0},//bOutRgainMax_a00_n00
			{0xbb, 0x40},//bOutBgainMin_a00_n00
			{0xbc, 0x68},//bOutBgainMax_a00_n00
...
static struct msm_camera_i2c_reg_conf hi351_fixed_fps_settings0[] = {
	// CAMCODER MODE : 30 ~ 22FPS
		...
		{0x03, 0x20}, //Page 20
#if defined (LGE_CAMERA_ANTIBAND_50HZ)	//Flicker 50Hz
	  {0x24, 0x00}, //EXP Max 16.67 fps (50Hz)
	  {0x25, 0x20},
	  {0x26, 0xf2},
	  {0x27, 0x20},
#else
	   {0x24, 0x00}, //EXP Max 15.00 fps (60Hz)
	   {0x25, 0x24},
	   {0x26, 0x9b},
	   {0x27, 0x40},
#endif
...
//	{0xFE, 0x0A}, //Delay 10ms
	...
	{0x03, 0x00}, //PAGE 0
#if defined (LGE_CAMERA_ANTIBAND_50HZ)	//Flicker 50Hz
	{0x90, 0x06}, //BLC_TIME_TH_ON  // STEVE for 50hz
	{0x91, 0x06}, //BLC_TIME_TH_OFF // STEVE for 50hz
	{0x92, 0xe8}, //BLC_AG_TH_ON  //STEVE AGC OxD0
	{0x93, 0xe0}, //BLC_AG_TH_OFF //STEVE AGC OxD0

	//DCDC
	{0x03, 0x02}, //PAGE 2
	{0xd4, 0x06}, //DCDC_TIME_TH_ON  // STEVE for 50hz
	{0xd5, 0x06}, //DCDC_TIME_TH_OFF // STEVE for 50hz
#else
...
static struct msm_camera_i2c_reg_conf hi351_scene_normal_settings[] = {
	...
	{0xb9, 0x64}, //STEVE bOutRgainMin_a00_n00
	{0xba, 0xf0}, //bOutRgainMax_a00_n00
	{0xbb, 0x40}, //bOutBgainMin_a00_n00
	{0xbc, 0x68}, //STEVE bOutBgainMax_a00_n00
...
//            
	...
	{0x11, 0xb0, MSM_CAMERA_I2C_BYTE_DATA}, //manual sleep onoff STEVE Y correnctio OFF 20120220 Dgain Lowlight
	...
	{0x13, 0x11, MSM_CAMERA_I2C_BURST_DATA}, //bCtl4_a00_n00 Y normalize OFF
...
//AWB target angle
	...
	//AWB target RG angle
	{0xaa, 0x32, MSM_CAMERA_I2C_BYTE_DATA},//aInRgTgtOfs_a00_n00
	{0xab, 0x28, MSM_CAMERA_I2C_BYTE_DATA},//aInRgTgtOfs_a01_n00
	...
	//AWB target BG angle
	{0xb2, 0xb2, MSM_CAMERA_I2C_BYTE_DATA},//aInBgTgtOfs_a00_n00
	{0xb3, 0xa8, MSM_CAMERA_I2C_BYTE_DATA},//aInBgTgtOfs_a01_n00
...
// Y wgt
	...
	{0x59, 0x6e, MSM_CAMERA_I2C_BURST_DATA},
	{0x5a, 0x73, MSM_CAMERA_I2C_BURST_DATA},
	{0x5b, 0x78, MSM_CAMERA_I2C_BURST_DATA},
	{0x5c, 0x7d, MSM_CAMERA_I2C_BURST_DATA},
	...
	{0x63, 0x8a, MSM_CAMERA_I2C_BURST_DATA},
	{0x64, 0x99, MSM_CAMERA_I2C_BURST_DATA},
	...
	{0x6b, 0x0a, MSM_CAMERA_I2C_BURST_DATA},
	{0x6c, 0x19, MSM_CAMERA_I2C_BURST_DATA},
	{0x6d, 0x00, MSM_CAMERA_I2C_BURST_DATA},
	{0x6e, 0x00, MSM_CAMERA_I2C_BURST_DATA},
	{0x6f, 0x00, MSM_CAMERA_I2C_BURST_DATA},
	...
	{0xb9, 0x64, MSM_CAMERA_I2C_BURST_DATA}, // steve OutRgainMin
	{0xba, 0xf0, MSM_CAMERA_I2C_BURST_DATA}, // steve OutRgainMax
	{0xbb, 0x40, MSM_CAMERA_I2C_BURST_DATA}, // steve OutBgainMin
	{0xbc, 0x68, MSM_CAMERA_I2C_BURST_DATA}, // steve OutBgainMax
	...
	{0x25, 0x45, MSM_CAMERA_I2C_BURST_DATA},  //CTEM low
...
//                                
	...
	{0x2c, 0x5E, MSM_CAMERA_I2C_BURST_DATA}, //LSC 02 Gain B
	{0x2d, 0x82, MSM_CAMERA_I2C_BURST_DATA}, //LSC 02 Gain R
	...
	{0x44, 0x74, MSM_CAMERA_I2C_BURST_DATA},//LSC 05 Gain B
	...
	{0x5c, 0x74, MSM_CAMERA_I2C_BURST_DATA}, //7c LSC 08 Gain B
	...
	{0x64, 0x88, MSM_CAMERA_I2C_BURST_DATA}, //7c LSC 09 Gain B
	{0x65, 0x70, MSM_CAMERA_I2C_BURST_DATA}, //80 LSC 09 Gain R
