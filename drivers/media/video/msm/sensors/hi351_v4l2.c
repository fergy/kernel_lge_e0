...
static struct msm_camera_i2c_conf_array hi351_init_conf[] = {
	{&hi351_recommend_settings[0],
	ARRAY_SIZE(hi351_recommend_settings), 0, MSM_CAMERA_I2C_BYTE_DATA}
};
#if 0
static struct msm_camera_i2c_conf_array hi351_confs[][4] = {

	{{&hi351_snap_settings0[0],
	ARRAY_SIZE(hi351_snap_settings0), 8, MSM_CAMERA_I2C_BYTE_DATA},
	 {&hi351_snap_settings1[0],
	ARRAY_SIZE(hi351_snap_settings1), 16, MSM_CAMERA_I2C_BYTE_DATA},
	 {&hi351_snap_settings2[0],
	ARRAY_SIZE(hi351_snap_settings2), 0, MSM_CAMERA_I2C_BYTE_DATA},
	 {&hi351_snap_settings3[0],
	ARRAY_SIZE(hi351_snap_settings3), 0, MSM_CAMERA_I2C_BYTE_DATA},},

	{{&hi351_prev_settings0[0],
	ARRAY_SIZE(hi351_prev_settings0), 10, MSM_CAMERA_I2C_BYTE_DATA},
...
static struct msm_camera_i2c_conf_array hi351_confs[] = {
	{&hi351_snap_settings[0],
	ARRAY_SIZE(hi351_snap_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
	{&hi351_prev_settings[0],
	ARRAY_SIZE(hi351_prev_settings), 0, MSM_CAMERA_I2C_BYTE_DATA},
};
...
static struct msm_sensor_output_info_t hi351_dimensions[] = {
	...
	{
		.x_output = 0x400,//1024 	//0x280, // 640
		.y_output = 0x300,//768	//0x1E0, // 480
...
#if 1
	{{hi351_exposure[0], ARRAY_SIZE(hi351_exposure[0]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[1], ARRAY_SIZE(hi351_exposure[1]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[2], ARRAY_SIZE(hi351_exposure[2]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[3], ARRAY_SIZE(hi351_exposure[3]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[4], ARRAY_SIZE(hi351_exposure[4]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[5], ARRAY_SIZE(hi351_exposure[5]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[6], ARRAY_SIZE(hi351_exposure[6]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[7], ARRAY_SIZE(hi351_exposure[7]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[8], ARRAY_SIZE(hi351_exposure[8]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[9], ARRAY_SIZE(hi351_exposure[9]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[10], ARRAY_SIZE(hi351_exposure[10]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[11], ARRAY_SIZE(hi351_exposure[11]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[12], ARRAY_SIZE(hi351_exposure[12]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_exposure[13], ARRAY_SIZE(hi351_exposure[13]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
#else
	{{hi351_exposure[0], ARRAY_SIZE(hi351_exposure[0]), 0,
		MSM_CAMERA_I2C_BYTE_DATA},},
...
static struct msm_camera_i2c_enum_conf_array
		 hi351_special_effect_enum_confs = {
...
static struct msm_camera_i2c_conf_array hi351_wb_oem_confs[][1] = {
	{{hi351_wb_oem[0], ARRAY_SIZE(hi351_wb_oem[0]),  0,			//Auto
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_wb_oem[1], ARRAY_SIZE(hi351_wb_oem[1]),  0,			//Incandescent
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_wb_oem[2], ARRAY_SIZE(hi351_wb_oem[2]),  0,			//fluorescent
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_wb_oem[3], ARRAY_SIZE(hi351_wb_oem[3]),  0,			//daylight
		MSM_CAMERA_I2C_BYTE_DATA},},
	{{hi351_wb_oem[4], ARRAY_SIZE(hi351_wb_oem[4]),  0,			//cloudy
		MSM_CAMERA_I2C_BYTE_DATA},},
};
...
static struct msm_camera_i2c_conf_array hi351_iso_confs[][1] = {
	...
	{{hi351_iso[2], ARRAY_SIZE(hi351_iso[2]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},				//100
	{{hi351_iso[3], ARRAY_SIZE(hi351_iso[3]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},				//200
	{{hi351_iso[4], ARRAY_SIZE(hi351_iso[4]),  0,
		MSM_CAMERA_I2C_BYTE_DATA},},				//400
	{{hi351_iso[5], ARRAY_SIZE(hi351_iso[5]),  0,
...
static struct msm_camera_i2c_enum_conf_array hi351_iso_enum_confs = {
	.conf = &hi351_iso_confs[0][0],
	.conf_enum = hi351_iso_enum_map,
	.num_enum = ARRAY_SIZE(hi351_iso_enum_map),
	.num_index = ARRAY_SIZE(hi351_iso_confs),
	.num_conf = ARRAY_SIZE(hi351_iso_confs[0]),
	.data_type = MSM_CAMERA_I2C_BYTE_DATA,
};


static struct msm_camera_i2c_conf_array hi351_fps_range_confs[][3] = {
	{
		{&hi351_attached_fps_settings0[0], ARRAY_SIZE(hi351_attached_fps_settings0),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_attached_fps_settings1[0], ARRAY_SIZE(hi351_attached_fps_settings1),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_attached_fps_settings2[0], ARRAY_SIZE(hi351_attached_fps_settings2),  0,
	       MSM_CAMERA_I2C_BYTE_DATA},

	},
	{
		{&hi351_auto_fps_settings0[0], ARRAY_SIZE(hi351_auto_fps_settings0),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_auto_fps_settings1[0], ARRAY_SIZE(hi351_auto_fps_settings1),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_auto_fps_settings2[0], ARRAY_SIZE(hi351_auto_fps_settings2),  0,
	       MSM_CAMERA_I2C_BYTE_DATA},
	},
	{
		{&hi351_fixed_fps_settings0[0], ARRAY_SIZE(hi351_fixed_fps_settings0),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_fixed_fps_settings1[0], ARRAY_SIZE(hi351_fixed_fps_settings1),  10,
	       MSM_CAMERA_I2C_BYTE_DATA},
	    {&hi351_fixed_fps_settings2[0], ARRAY_SIZE(hi351_fixed_fps_settings2),  0,
	       MSM_CAMERA_I2C_BYTE_DATA},
	},
};
...
static struct msm_camera_i2c_enum_conf_array hi351_fps_range_enum_confs = {
	.conf = &hi351_fps_range_confs[0][0],
	.conf_enum = hi351_fps_range_enum_map,
	.num_enum = ARRAY_SIZE(hi351_fps_range_enum_map),
	.num_index = ARRAY_SIZE(hi351_fps_range_confs),
	.num_conf = ARRAY_SIZE(hi351_fps_range_confs[0]),
	.data_type = MSM_CAMERA_I2C_BYTE_DATA,
};
...
static int hi351_bestshot_mode_enum_map[] = {
...
static struct msm_camera_i2c_enum_conf_array hi351_bestshot_mode_enum_confs = {
	.conf = &hi351_bestshot_mode_confs[0][0],
	.conf_enum = hi351_bestshot_mode_enum_map,
	.num_enum = ARRAY_SIZE(hi351_bestshot_mode_enum_map),
	.num_index = ARRAY_SIZE(hi351_bestshot_mode_confs),
	.num_conf = ARRAY_SIZE(hi351_bestshot_mode_confs[0]),
	.data_type = MSM_CAMERA_I2C_BYTE_DATA,
};
...
//		.s_v4l2_ctrl = hi351_effect_msm_sensor_s_ctrl_by_enum,
	...
	},
	{
		...
		.step = 1,
		.enum_cfg_settings = &hi351_iso_enum_confs,
		.s_v4l2_ctrl = hi351_msm_sensor_s_ctrl_by_enum,
	},
	{
		...
		.step = 1,
		.enum_cfg_settings = &hi351_fps_range_enum_confs,
		.s_v4l2_ctrl = hi351_msm_sensor_s_ctrl_by_enum,
    },
    {
		...
		.step = 1,
		.enum_cfg_settings = &hi351_bestshot_mode_enum_confs,
		.s_v4l2_ctrl = hi351_msm_sensor_s_ctrl_by_enum,
	},
};

static struct msm_camera_csi_params hi351_csic_params = {
...
static struct msm_camera_csi_params *hi351_csic_params_array[] = {
	&hi351_csic_params,
	&hi351_csic_params,
};
...
//static struct sensor_calib_data hi351_calib_data;
...
static int32_t hi351_i2c_write_b_table(struct msm_camera_i2c_client *client,
								struct msm_camera_i2c_reg_conf *reg_conf_tbl, uint16_t size)
{
	int i;
	int32_t rc = 0;
	for (i = 0; i < size; i++) {
			rc = hi351_i2c_write_b_sensor(client, reg_conf_tbl->reg_addr,
...
static int32_t hi351_reg_init(struct msm_sensor_ctrl_t *s_ctrl) {
	...
	for (retry = 0; retry < 3; ++retry) {
		...
		for ( i = 0; i < ARRAY_SIZE(hi351_init_conf); i++) {
			rc = hi351_sensor_write_init_settings(s_ctrl->sensor_i2c_client,
						(struct msm_camera_i2c_reg_conf *) hi351_init_conf[i].conf, hi351_init_conf[i].size);
...
int32_t hi351_sensor_write_conf_array(struct msm_camera_i2c_client *client,
...
int hi351_sensor_power_down(struct msm_sensor_ctrl_t *s_ctrl)
{
	struct msm_camera_sensor_info *data = s_ctrl->sensordata;
	int32_t rc = 0;
	printk("%s: E %d\n", __func__, __LINE__);
...
void hi351_sensor_start_stream(struct msm_sensor_ctrl_t *s_ctrl)
{
	hi351_camera_i2c_write_tbl(
	        s_ctrl->sensor_i2c_client,
...
void hi351_sensor_stop_stream(struct msm_sensor_ctrl_t *s_ctrl)
{
	hi351_camera_i2c_write_tbl(
	        s_ctrl->sensor_i2c_client,
...
static struct msm_sensor_fn_t hi351_func_tbl = {
	.sensor_start_stream = hi351_sensor_start_stream,
	.sensor_stop_stream = hi351_sensor_stop_stream,
...
//	.sensor_set_wb = hi351_set_wb,
//	.sensor_set_effect = hi351_set_effect,
//	.sensor_set_brightness = hi351_set_brightness,
//	.sensor_set_soc_minmax_fps = hi351_set_fps,
	.sensor_match_id = hi351_match_id,
	.sensor_get_soc_snapshotdata = hi351_get_snapshot_data,
#endif
};
...
static struct msm_sensor_ctrl_t hi351_s_ctrl = {
	...
	.csic_params = &hi351_csic_params_array[0],
