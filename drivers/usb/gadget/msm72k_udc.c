...
#if (defined(CONFIG_MACH_MSM7X27A_U0) && defined(CONFIG_LGE_USB_GADGET_DRIVER)) || defined(CONFIG_MACH_MSM7X25A_V1)
...
/*                                                                         */
		...
		wake_lock_timeout(&ui->TA_wlock,2 * HZ);
#elif defined(CONFIG_MACH_MSM7X27A_U0) || defined(CONFIG_MACH_MSM7X25A_V1)
		wake_lock_timeout(&ui->TA_wlock,2 * HZ);
