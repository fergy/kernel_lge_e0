...
static char ili9488_config_positive_gamma_correc[16]={
	...
	0x05, 0x10, 0x06, 0x3C,
	0x88, 0x54, 0x0A, 0x0D,
	0x0B, 0x30, 0x36, 0x0F}; //DTYPE_GEN_LWRITE
#elif 0 // 20130401 from ILITEK GAMMA Tune
	0xE0, 0x00, 0x11, 0x13,
	0x06, 0x11, 0x06, 0x3D,
	0x88, 0x53, 0x0A, 0x0C,
	0x0A, 0x30, 0x36, 0x0F}; //DTYPE_GEN_LWRITE
#elif 1 //20130402_version 1
	0xE0, 0x00, 0x11, 0x13,
	0x07, 0x12, 0x08, 0x3D,
	0x88, 0x53, 0x08, 0x0B,
	0x09, 0x30, 0x36, 0x0F}; //DTYPE_GEN_LWRITE
#elif 0 //20130402_version 2
	0xE0, 0x00, 0x11, 0x13,
	0x08, 0x13, 0x08, 0x3D,
	0x88, 0x53, 0x08, 0x0A,
	0x08, 0x30, 0x36, 0x0F}; //DTYPE_GEN_LWRITE
#elif 0 //20130402_version 3
	0xE0, 0x00, 0x11, 0x13,
	0x09, 0x14, 0x08, 0x3D,
	0x88, 0x53, 0x08, 0x09,
	0x07, 0x30, 0x36, 0x0F}; //DTYPE_GEN_LWRITE
#endif
static char ili9488_config_negative_gamma_correc[16]={
	...
	0x04, 0x12, 0x04, 0x29,
	0x44, 0x42, 0x09, 0x0F,
	0x0A, 0x2B, 0x2D, 0x0F}; //DTYPE_GEN_LWRITE
#elif 0 // 20130401 from ILITEK GAMMA Tune 
	0xE1, 0x00, 0x07, 0x0D,
	0x05, 0x13, 0x04, 0x2A,
	0x44, 0x41, 0x09, 0x0E,
	0x09, 0x2B, 0x2D, 0x0F}; //DTYPE_GEN_LWRITE
#elif 1 //20130402_version 1
	0xE1, 0x00, 0x07, 0x0D,
	0x06, 0x14, 0x06, 0x2A,
	0x44, 0x41, 0x0A, 0x0D,
	...
	0x07, 0x15, 0x06, 0x2A,
	0x44, 0x41, 0x0A, 0x0C,
	0x08, 0x2B, 0x2D, 0x0F}; //DTYPE_GEN_LWRITE
#elif 0 //20130402_version 3
	0xE1, 0x00, 0x07, 0x0D,
	0x08, 0x16, 0x06, 0x2A,
	0x44, 0x41, 0x0A, 0x0B,
	0x07, 0x2B, 0x2D, 0x0F}; //DTYPE_GEN_LWRITE
#endif

#if 1
static char ili9488_config_power_vcom_control[4]={
	0xC5, 0x00, 0x60, 0x80};
//	0x00, 0xff, 0xff, 0xff}; //DTYPE_GEN_LWRITE
#else
static char ili9488_config_power_vcom_control[8]={
	0xC5, 0x00, 0x50, 0x80,
	0x00, 0xff, 0xff, 0xff}; //DTYPE_GEN_LWRITE
#endif
...
#else
static char ili9488_config_display_func[4]={
	0xB6, 0x00, 0x42, 0x3B};  //DTYPE_GEN_LWRITE
#endif

//Not Using at ILI9486 
...
///////////////////////////////////////////////////////
///////////////////////////////////////////////////////
//Not Using in ILI9486
#if 0
static char ili9488_interface_mode_ctrl[2]={
	0xB0, 0x00}; //DTYPE_GEN_WRITE2
#endif
///////////////////////////////////////////////////////
///////////////////////////////////////////////////////
